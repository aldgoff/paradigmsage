# Navigation Invariants and Failure Modes (PoP Site)
  This document defines the **non-negotiable navigation invariants** and known **failure modes** for the ParadigmSage website. 
  It is intended to be copyable, portable, and reusable as a charter for any nav-related work.

# Navigation Invariants (What Must Always Be True)

  ## I1. PoP Is the Primary Spine
  ...
  ## I2. Navigation Axes Are Orthogonal
  ...
  ## I3. Activation Is Demand-Driven
  ...
  ## I6. Local Context Beats Global Menus
