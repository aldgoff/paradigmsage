...
*A complete guide for those who prefer to look before they leap.*
...
### Setup Panel
  ...
  - To make a puzzle, place pieces individually, then freeze the setup.
    - Stacks can be manipulated by selecting both subpieces and one or two tiles.
    - To place a piece, select it and a tile, then hit *Place Piece*.
    - To move a piece around the board, select it and a tile, then hit *Shift Piece*.
    - To return a piece to the tray, just select it and hit *Return Piece*.
    - Stacks can be manipulated by selecting both subpieces and one or two tiles.
  - To start a conventional game, click on *Starting Position*.
...
### AdvSq Panel
  ...
  - Can also click to place a new advsq or shift an existing one.
  - Explore your investigations with the undo system **Game Panel**.
...
### Gambit Panel
  ...
  - Clicking a button freezes the current advancement square as part of the gambit.
    ...
    - The stride tile must be a duke duplex tile (apex in a face quadrant) to freeze as a duplex move.
    - The stride tile must be an overlap tile (brook, qtile, hotspot, or Feynman) to freeze as an overlap move (queen, stack).

### Move Panel
  - Intended to list the moves of the game.
